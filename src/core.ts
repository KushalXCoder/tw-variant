 ...
 * // "px-4 py-2"
 */
export const hv = (classes: string, variant?: string): string => {
...
export const processTv = (config: Record<string, string>): string => {
  ...
  if (base.trim() && variantsResult) return base.trim() + " " + variantsResult;
